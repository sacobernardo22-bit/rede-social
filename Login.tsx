    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 p-4">
      <div className="max-w-md w-full space-y-8 bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-800">
        <div className="text-center">
          ...
          <p className="mt-2 text-slate-600 dark:text-slate-400">Bem-vindo de volta! Entre na sua conta.</p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleLogin}>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <label className="ml-2 block text-sm text-slate-600 dark:text-slate-400">Lembrar de mim</label>
            </div>
